...
<div class="page-content">
    ...
    <div class="bv-page-header">
        ...
        <div>
            <h1 class="bv-page-title">Edit <em>Event Venue</em></h1>
            <p class="bv-page-sub">Update Event Venue for {{ $venue->name }}</p>
        </div>
    </div>
            ...
            <form method="POST" action="{{ route('admin.venue.update', $venue->id) }}">
                ...
                <div class="bv-card">
                    <div class="bv-card-header">
                        ...
                        <div>
                            <div class="bv-card-header-title">Venue Details</div>
                            <div class="bv-card-header-sub">Basic information about this venue</div>
                        </div>
                    </div>
                    ...
                    <div class="bv-card-body">
                        ...
                        {{-- Name --}}
                        <div class="bv-field">
                            <label class="bv-label" for="VenueName">
                                Venue Name
                        ...
                        <div class="bv-field">
                            ...
                            <textarea
                                ...
                                placeholder="Briefly describe this venue — mood, style, typical décor…"
                    ...
                    <div class="bv-form-actions">
                        <span style="font-size:0.72rem;color:#C0B8B0;">
                            Last updated: {{ $venue->updated_at->diffForHumans() }}
                        </span>
            ...
            <div class="bv-meta-card">
                ...
                <div class="bv-meta-body">
                    ...
                    <div class="bv-meta-row">
                        ...
                        <span class="bv-meta-val">#{{ $venue->id }}</span>
                    </div>
                    <div class="bv-meta-row">
                        <span class="bv-meta-key">Created</span>
                        <span class="bv-meta-val">{{ $venue->created_at->format('M d, Y') }}</span>
                    </div>
                    <div class="bv-meta-row">
                        <span class="bv-meta-key">Last Modified</span>
                        <span class="bv-meta-val">{{ $venue->updated_at->format('M d, Y') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bv-danger-card">
                ...
                <div class="bv-danger-body">
                    <p class="bv-danger-desc">
                        Permanently deletes <strong>{{ $venue->name }}</strong> and removes it from all associated events. This action cannot be undone.
                    </p>
                    <form method="POST" action="{{ route('admin.venue.destroy', $venue->id) }}">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="bv-btn-delete"
                            onclick="return confirm('Delete {{ addslashes($venue->name) }}? This cannot be undone.')">
