...
<div class="page-content">
    ...
    <div class="bv-page-header">
        <a href="{{ route('admin.venue.list') }}" class="bv-back-btn">
        ...
        <div>
            <h1 class="bv-page-title">Edit <em>Location</em></h1>
            <p class="bv-page-sub">Update Locations details for {{ $location->name }}</p>
        </div>
    </div>
                ...
                <div class="bv-card">
                    <div class="bv-card-header">
                        ...
                        <div>
                            ...
                            <div class="bv-card-header-sub">Basic information about this venue location</div>
                        </div>
                    </div>
                    ...
                    <div class="bv-card-body">
                        ...
                        {{-- Name --}}
                        <div class="bv-field">
                            <label class="bv-label" for="LocationsName">
                                Location Name
                            ...
                            @enderror
                            <p class="bv-input-hint">Keep it short and descriptive — this shows on venue listing pages.</p>
                        </div>
                        ...
                        <div class="bv-field">
                            ...
                            <textarea
                                ...
                                placeholder="Briefly describe this location — mood, style, typical décor…"
                    ...
                    <div class="bv-form-actions">
                        <span style="font-size:0.72rem;color:#C0B8B0;">
                            Last updated: {{ $location->updated_at->diffForHumans() }}
                        </span>
                        <div class="bv-form-actions-right">
                            <a href="{{ route('admin.venue.list') }}" class="bv-btn-cancel">
                                <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="bv-meta-card">
                ...
                <div class="bv-meta-body">
                    ...
                    <div class="bv-meta-row">
                        ...
                        <span class="bv-meta-val">#{{ $location->id }}</span>
                    </div>
                    <div class="bv-meta-row">
                        <span class="bv-meta-key">Created</span>
                        <span class="bv-meta-val">{{ $location->created_at->format('M d, Y') }}</span>
                    </div>
                    <div class="bv-meta-row">
                        <span class="bv-meta-key">Last Modified</span>
                        <span class="bv-meta-val">{{ $location->updated_at->format('M d, Y') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bv-danger-card">
                ...
                <div class="bv-danger-body">
                    <p class="bv-danger-desc">
                        Permanently deletes <strong>{{ $location->name }}</strong> and removes it from all associated events. This action cannot be undone.
                    </p>
                    <form method="POST" action="{{ route('admin.venue.destroy', $location->id) }}">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="bv-btn-delete"
                            onclick="return confirm('Delete {{ addslashes($location->name) }}? This cannot be undone.')">
