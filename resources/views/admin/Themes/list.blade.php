...
<div class="page-content">
    ...
    <div class="bv-page-header">
        <div>
            <h1 class="bv-page-title">Event <em>Themes</em></h1>
    ...
    <div class="bv-card">
        ...
        <table class="bv-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="bv-theme-name">
                            <span class="bv-theme-dot"></span>
                            {{ $theme->name }}
                        </div>
                    </td>
                    <td>
                        <span class="bv-theme-desc" title="{{ $theme->description }}">
                            {{ $theme->description ?: '—' }}
                        </span>
                    </td>
                    <td>
                        <div class="bv-actions">
                            <a href="{{ route('admin.themes.edit', $theme->id) }}" class="bv-btn-edit">
                                <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7">
                                    <path d="M11.5 2.5l2 2L5 13H3v-2L11.5 2.5z"/>
                                </svg>
                                Edit
                            </a>
                            <form method="POST" action="{{ route('admin.themes.destroy', $theme->id) }}" style="display:inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="bv-btn-delete"
                                    onclick="return confirm('Delete {{ addslashes($theme->name) }}?')">
                                    <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.7">
        ...
        <div class="bv-empty">
            ...
            <div class="bv-empty-title">No themes yet</div>
            <p class="bv-empty-sub">Click <strong>Add Theme</strong> to create your first event theme.</p>
        </div>
        @endif
    </div>
...
<div id="categoryModal" class="bv-modal-backdrop">
    <div class="bv-modal">
        <div class="bv-modal-header">
            <span class="bv-modal-title">Add <em>Theme</em></span>
        ...
        <form method="POST" action="{{ route('admin.themes.store') }}">
            ...
            <div class="bv-modal-body">
                ...
                <div class="bv-field">
                    <label class="bv-label" for="themeName">Theme Name</label>
                    <input id="themeName" name="name" type="text"
                           class="bv-input" placeholder="e.g. Garden Wedding, Corporate Gala…"
                           required>
                </div>

                <div class="bv-field" style="margin-bottom:0">
                    <label class="bv-label" for="themeDesc">Description</label>
                    <textarea id="themeDesc" name="description"
                              class="bv-textarea"
                              placeholder="Briefly describe this theme…"></textarea>
                </div>
            ...
            <div class="bv-modal-footer">
                ...
                <button type="submit" class="bv-btn-save">Save Theme</button>
            </div>
        </form>
    </div>
</div>
