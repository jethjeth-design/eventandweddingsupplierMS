<x-app-layout>
    ...
    <div class="page-content">
        ...
        <div class="bv-page-header">
            <div>
                <h1 class="bv-page-title">Users <em></em></h1>
                <p class="bv-page-sub">Manage User's Roles</p>
            </div>
        ...
        <div class="bv-card">
            ...
            <table class="bv-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="bv-users-name">
                                <span class="bv-users-dot"></span>
                                {{ $users->name }}
                            </div>
                        </td>
                        <td>
                            <span class="bv-users-desc" title="{{ $users->email }}">
                                {{ $users->email ?: '—' }}
                            </span>
                        </td>
                        <td>
            ...
            <div class="bv-empty">
                ...
                <div class="bv-empty-title">No User's yet</div>
                <p class="bv-empty-sub">Click <strong>Manage</strong> your User's</p>
            </div>
            @endif
        </div>
