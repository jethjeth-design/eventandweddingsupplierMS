...
<div class="page-content">
    ...
    <div class="bv-page-header">
        ...
        <div>
            <h1 class="bv-page-title">Edit <em>category</em></h1>
            <p class="bv-page-sub">Update category details for {{ $category->name }}</p>
        </div>
    </div>
                ...
                <div class="bv-card">
                    <div class="bv-card-header">
                        ...
                        <div>
                            ...
                            <div class="bv-card-header-sub">Basic information about this event category</div>
                        </div>
                    </div>
                    ...
                    <div class="bv-card-body">
                        ...
                        <div class="bv-field">
                            ...
                            <textarea
                                ...
                                placeholder="Briefly describe this category — mood, style, typical décor…"
            ...
            <div class="bv-meta-card">
                ...
                <div class="bv-meta-body">
                    ...
                    <div class="bv-meta-row">
                        ...
                        <span class="bv-meta-val">#{{ $category->id }}</span>
                    </div>
                    <div class="bv-meta-row">
                        <span class="bv-meta-key">Created</span>
                        <span class="bv-meta-val">{{ $category->created_at->format('M d, Y') }}</span>
                    </div>
                    <div class="bv-meta-row">
                        <span class="bv-meta-key">Last Modified</span>
                        <span class="bv-meta-val">{{ $category->updated_at->format('M d, Y') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bv-danger-card">
                ...
                <div class="bv-danger-body">
                    <p class="bv-danger-desc">
                        Permanently deletes <strong>{{ $category->name }}</strong> and removes it from all associated events. This action cannot be undone.
                    </p>
