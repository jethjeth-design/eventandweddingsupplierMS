...
<head>
    ...
    <title>{{ $popular->name }} — Bikol's Craft</title>
...
<div class="mobile-menu" id="mobileMenu">
    ...
    <a href="{{ route('welcomepage.package') }}" class="{{ request()->routeIs('welcomepage.package') ? 'nav-active' : '' }}" onclick="closeMenu()">Packages</a>
    @if (Route::has('login'))
        @auth
        ...
        <div class="match-grid" id="matchGrid">
            ...
            <div class="match-card"
                ...
                <div class="mc-foot">
                    ...
                    <a href="#" class="pp-view-btn" style="display:inline-flex;align-items:center;gap:0.3rem;padding:0.38rem 0.85rem;border-radius:6px;border:1.5px solid var(--border-md);background:var(--white);font-family:var(--font-body);font-size:0.72rem;font-weight:500;color:var(--charcoal);text-decoration:none;transition:border-color 0.2s,background 0.2s,color 0.2s;white-space:nowrap;">
                        View
