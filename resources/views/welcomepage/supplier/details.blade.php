...
<head>
    ...
    <title>{{ $supplier->business_name }} — WES TEAM</title>
...
<body>
    ...
    <nav class="main-nav">
        ...
        <div class="nav-links">
            ...
            <a href="{{route('welcomepage.event')}}">Events</a>
    ...
    <div class="page-wrap">
        ...
        <div class="profile-card reveal">
            ...
            <div class="profile-top">
                @if ($supplier->photo)
                    <img class="profile-photo" src="{{ asset('storage/' . $supplier->photo) }}"
        ...
        <div class="stats-strip reveal">
            ...
            <div class="stat-cell">
                <span class="stat-n"
                    style="font-size:1.1rem;font-family:var(--font-body);font-weight:600;color:{{ $supplier->is_available ? '#15803D' : '#B45309' }};">
                        ...
                        <ul class="detail-list">
                                ...
                                <li class="detail-item">
                                    <div class="detail-icon">
                                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path
                                                d="M22 16.92v3a2 2 0 0 1-2.18 2A19.79 19.79 0 0 1 11.63 19a19.5 19.5 0 0 1-6-6A19.79 19.79 0 0 1 3.12 4.18 2 2 0 0 1 5.08 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81a2 2 0 0 1-.45 2.11L9.09 9.91A16 16 0 0 0 15 15.91l1.27-1.27a2 2 0 0 1 2.11-.45c.91.34 1.85.57 2.81.7A2 2 0 0 1 22 16.92z" />
                                        </svg>
                                    </div>
                                    <div>
                                        <div class="detail-lbl">Phone</div>
                                        <div class="detail-val"><a
                                                href="tel:{{ $supplier->phone }}">{{ $supplier->phone }}</a></div>
                                    </div>
                                </li>
                            @endif
                            ...
                            <li class="detail-item">
                                ...
                                <div>
                                    ...
                                    <div class="detail-val"
                                        style="color:{{ $supplier->is_available ? '#15803D' : '#B45309' }};font-weight:500;">
                    ...
                    <div class="sc-body">
                        ...
                        <div class="contact-row">
                            ...
                            <div>
                                ...
                                <div class="c-val"
                                    style="font-weight:500;color:{{ $supplier->is_available ? '#15803D' : '#B45309' }};">
        ...
        <div class="modal-box">
            <div class="modal-hd">
                <div>
                    ...
                    <div class="modal-hd-sub">{{ $supplier->first_name }}
                        {{ $supplier->last_name }}{{ $supplier->category ? ' · ' . $supplier->category : '' }}</div>
                </div>
            ...
            <form action="{{ route('inquiry.store') }}" method="POST" style="display:contents;">
                ...
                <div class="modal-body">
                    ...
                    <div class="fm-grid">
                        <div class="fm-field" style="margin-bottom:0;">
                            ...
                            <input class="fm-in" type="email" name="email" placeholder="you@email.com"
                                required>
                        </div>
                        <div class="fm-field" style="margin-bottom:0;">
                            <label class="fm-lbl">Phone <span
                                    style="font-weight:300;color:#B0A89E;">(optional)</span></label>
                            <input class="fm-in" type="tel" name="phone" placeholder="+63 912 345 6789">
                        </div>
                    </div>
                    <div class="fm-field">
                        <label class="fm-lbl">Subject</label>
                        <input class="fm-in" type="text" name="subject"
                ...
                <div class="modal-footer">
                    <button type="button" class="outline-btn" style="width:auto;padding:0.6rem 1.2rem;margin:0;"
                        onclick="closeModal()">Cancel</button>
                    <button type="submit" class="full-btn" style="width:auto;padding:0.6rem 1.6rem;margin:0;">Send
                        Message</button>
                </div>
            </form>
        </div>
