...
<body>
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <a href="{{ route('welcomepage.event') }}" class="{{ request()->routeIs('events*') ? 'mob-active' : '' }}"
                            ...
                            <div class="sp-card-photo">
                                ...
                                <div class="featured-badge">
                                    <svg viewBox="0 0 10 10">
                                        <polygon
                                            points="5,1 6.2,3.7 9,4.1 7,6.1 7.5,9 5,7.6 2.5,9 3,6.1 1,4.1 3.8,3.7" />
                                    </svg>
                                    Featured
                                </div>
            ...
            <div class="hs-head">
                <div class="hs-head-l">
                    ...
                    <div>
                        ...
                        <div class="hs-sub">Suppliers Packages</div>
                    </div>
                </div>
            </div>
