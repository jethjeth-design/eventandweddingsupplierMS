    ...
    <style>
        ...
        *::after {
        ...
        .cat-card:hover {
            ...
            box-shadow: 0 12px 32px rgba(30, 27, 24, 0.12);
        }
        ...
        .cta-section .btn-ghost {
            color: var(--charcoal);
            border: 1.5px solid rgba(30, 27, 24, 0.2);
        }
...
<body>
    ...
    <nav class="main-nav">
        ...
        <div class="nav-links">
            ...
            <a href="{{ route('welcomepage.event') }}" class="{{ request()->routeIs('welcomepage.event') ? 'nav-active' : '' }}">Events</a>
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <a href="{{ route('welcomepage.event') }}" class="{{ request()->routeIs('welcomepage.event') ? 'mob-active' : '' }}"
    ...
    <section class="hero">
        ...
        <div class="hero-content">
            ...
            <h1 class="hero-title">
                {{ $banner->hero_title_1 ?? 'Your Perfect Event,' }}<br><em>{{ $banner->hero_title_2 ?? 'Beautifully Managed' }}</em>
            </h1>
            <p class="hero-subtitle">
                {{ $banner->hero_subtitle ?? 'Connect with the finest venues, caterers, photographers, and decorators. ' }}
            </p>
    ...
    <section class="features-section" id="features">
        <div class="reveal">
            ...
            <h2 class="section-title">
                {{ $section->section_title ?? 'Everything you need to create' }}<br><em>{{ $section->section_subtitle ?? 'unforgettable moments' }}</em>
            </h2>
        </div>
        <div class="features-grid reveal">
            <div class="feature-card">
                <svg class="feature-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor"
                    stroke-width="1.5">
                    <rect x="8" y="14" width="32" height="26" rx="2" />
                    <path d="M16 14V10M32 14V10M8 22h32" />
                    <path d="M17 30l4 4 10-10" />
                </svg>
                <div class="feature-title">{{ $section->feature_title ?? 'Smart Booking System' }}</div>
                <p class="feature-desc">{{ $section->feature_desc ?? 'Manage all supplier bookings, contracts, and payment schedules from a single, intuitive dashboard.' }}</p>
            </div>
            <div class="feature-card">
                <svg class="feature-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor"
                    stroke-width="1.5">
                ...
                <div class="feature-title">{{ $section->feature_title2 ?? 'Supplier Profiles & Reviews' }}</div>
                <p class="feature-desc">{{ $section->feature_desc2 ?? 'Explore detailed supplier portfolios, verified reviews, and real-time availability before committing.' }}</p>
            </div>
            <div class="feature-card">
                <svg class="feature-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor"
                    stroke-width="1.5">
                ...
                <div class="feature-title">{{ $section->feature_title3 ?? 'Venue Discovery' }}</div>
                <p class="feature-desc">{{ $section->feature_desc3 ?? 'Filter by capacity, location, style, and budget across thousands of premium event venues nationwide.' }}</p>
            </div>
            <div class="feature-card">
                <svg class="feature-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor"
                    stroke-width="1.5">
                ...
                <div class="feature-title">{{ $section->feature_title4 ?? 'Budget Planner' }}</div>
                <p class="feature-desc">{{ $section->feature_desc4 ?? 'Track spending across all categories, compare quotes, and stay within budget with real-time breakdowns.' }}</p>
            </div>
            <div class="feature-card">
                <svg class="feature-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor"
                    stroke-width="1.5">
                ...
                <div class="feature-title">{{ $section->feature_title5 ?? 'Collaboration Hub' }}</div>
                <p class="feature-desc">{{ $section->feature_desc5 ?? 'Invite your planner, family, and wedding party to collaborate, comment, and approve selections together.' }}</p>
            </div>
            <div class="feature-card">
                <svg class="feature-icon" viewBox="0 0 48 48" fill="none" stroke="currentColor"
                    stroke-width="1.5">
                ...
                <div class="feature-title">{{ $section->feature_title6 ?? 'Premium Packages' }}</div>
                <p class="feature-desc">{{ $section->feature_desc6 ?? 'Curated bundles from top-tier suppliers designed for different event styles, sizes, and budgets.' }}</p>
            </div>
        </div>
    </section>
    ...
    <section class="categories-section" id="categories">
        ...
        <div class="cats-grid reveal">
            <div class="cat-card">
                <div class="cat-bg"
                    style="background-image: url('https://images.unsplash.com/photo-1519167758481-83f550bb49b3?w=400&q=70');">
                </div>
                <div class="cat-info">
            ...
            <div class="cat-card">
                <div class="cat-bg"
                    style="background-image: url('https://images.unsplash.com/photo-1555244162-803834f70033?w=400&q=70');">
                </div>
                <div class="cat-info">
            ...
            <div class="cat-card">
                <div class="cat-bg"
                    style="background-image: url('https://images.unsplash.com/photo-1500541374084-6b26a9d1e5c9?w=400&q=70');">
                </div>
                <div class="cat-info">
            ...
            <div class="cat-card">
                <div class="cat-bg"
                    style="background-image: url('https://images.unsplash.com/photo-1487530811015-780a5b16f8c1?w=400&q=70');">
                </div>
                <div class="cat-info">
            ...
            <div class="cat-card">
                <div class="cat-bg"
                    style="background-image: url('https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=400&q=70');">
                </div>
                <div class="cat-info">
            ...
            <div class="cat-card">
                <div class="cat-bg"
                    style="background-image: url('https://images.unsplash.com/photo-1478146059778-26028b07395a?w=400&q=70');">
                </div>
                <div class="cat-info">
    ...
    <section class="how-section">
        ...
        <div class="steps-row reveal">
            <div class="step">
                ...
                <p class="step-desc">Set your date, guest count, style, and budget to get a personalised supplier
                    match.</p>
            </div>
            <div class="step">
                <div class="step-num">02</div>
                <div class="step-title">Browse & Compare</div>
                <p class="step-desc">Explore curated suppliers, view portfolios, read reviews, and compare quotes
                    side-by-side.</p>
            </div>
            <div class="step">
                <div class="step-num">03</div>
                <div class="step-title">Book Securely</div>
                <p class="step-desc">Confirm bookings with digital contracts, secure deposits, and automated reminders.
                </p>
            </div>
            <div class="step">
