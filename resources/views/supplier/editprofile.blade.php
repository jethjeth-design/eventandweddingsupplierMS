            ...
            <div class="bv-sc-body">
                <div class="bv-fg">
                    ...
                    <div class="bv-f">
                        ...
                        <div class="bv-iw">
                            <svg class="bv-ico" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.7">
                                <path d="M2 10h16M10 2l8 8-8 8-8-8 8-8z"/>
                            </svg>
            ...
            <div class="bv-sc-body" style="display:flex;flex-direction:column;gap:1rem;">
                <div class="bv-f">
                    ...
                    <textarea id="fi_bio" name="bio" class="bv-ta"
                              ...
                              maxlength="500"
                              oninput="bvCt('bioC', this, 500)">{{ old('bio', $supplierProfile->bio) }}</textarea>
                    <div class="bv-cf">
                        <span class="bv-cc" id="bioC">{{ strlen(old('bio', $supplierProfile->bio ?? '')) }} / 500</span>
                    </div>
                    @error('bio')<div class="bv-err">{{ $message }}</div>@enderror
                </div>

                <div class="bv-f">
                    <label class="bv-lbl" for="fi_desc">
                        Service Description <span class="bv-req">Required</span>
                    </label>
                    <textarea id="fi_desc" name="description" class="bv-ta" style="min-height:115px;"
                              placeholder="Describe your services, pricing range, availability..."
                              maxlength="1000" required
                              oninput="bvCt('descC', this, 1000)">{{ old('description', $supplierProfile->description) }}</textarea>
                    <div class="bv-cf">
                        <span class="bv-cc" id="descC">{{ strlen(old('description', $supplierProfile->description ?? '')) }} / 1000</span>
                    </div>
