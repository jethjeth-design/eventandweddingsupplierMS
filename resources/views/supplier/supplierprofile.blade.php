<x-supplier-layout>
    <style>
        ...
        @media(max-width:860px) {
            ...
            .bv-profile-sidebar::-webkit-scrollbar {
                display: none;
            }
        ...
        .bv-id-avatar {
            ...
            box-shadow: 0 4px 18px rgba(30, 27, 24, 0.2);
        }
        ...
        .bv-id-avatar.has-photo img {
            display: block;
        }

        .bv-id-avatar.has-photo span {
            display: none;
        }
        ...
        .bv-completion-fill {
            height: 100%;
            background: linear-gradient(90deg, var(--gold), #e6c84a);
            border-radius: 3px;
        ...
        .cp-modal {
            ...
            border-radius: 14px;
            border: 1px solid #F0EBE5;
            box-shadow: 0 8px 40px rgba(30, 27, 24, 0.2);
            width: 100%;
            max-width: 480px;
            overflow: hidden;
        ...
        .fb-lb-strip::-webkit-scrollbar {
            height: 3px;
        }

        .fb-lb-strip::-webkit-scrollbar-thumb {
        ...
        @media(max-width:480px) {
            ...
            .bv-header-actions .bv-btn-primary span {
                display: none;
            }
        }
    </style>
                ...
                <div class="bv-header-actions">
                    ...
                    <a href="{{ route('supplier.profile') }}" class="bv-btn-secondary">
                        <svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8">
                            ...
                            <path
                                d="M7 1v1.2M7 11.8V13M1 7h1.2M11.8 7H13M2.8 2.8l.85.85M10.35 10.35l.85.85M10.35 3.65l-.85.85M3.65 10.35l-.85.85" />
                        </svg>
                        Account Settings
                    </a>
                    ...
                    <div id="panel-info" class="bv-tab-panel active">
                            ...
                            <div class="bv-id-card-banner">
                                @if (!empty($supplierProfile->cover_photo))
                                    <img class="bv-id-card-banner-img"
                                        src="{{ asset('storage/' . $supplierProfile->cover_photo) }}" alt="Cover photo">
                                    <div class="bv-id-card-banner-overlay"></div>
                                @endif
                                <button type="button" class="bv-cover-btn" onclick="cpModalOpen()">
                                    <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8">
                                        <path
                                            d="M1 5a2 2 0 012-2h1.5l1-1.5h5L11.5 3H13a2 2 0 012 2v7a2 2 0 01-2 2H3a2 2 0 01-2-2V5z" />
                                ...
                                <div class="bv-id-main">
                                    ...
                                    <div class="bv-id-meta">
                                        <div class="bv-id-meta-row">
                                            <svg class="bv-id-meta-icon" viewBox="0 0 16 16" fill="none"
                                                stroke="currentColor" stroke-width="1.7">
                                                <rect x="1" y="3" width="14" height="10" rx="2" />
                                                <path d="M1 6l7 4 7-4" />
                                            </svg>
                                            <div class="bv-id-meta-text">
                                                <strong>Email</strong>{{ Auth::user()->email }}</div>
                                        </div>
                                        @if ($supplierProfile->phone)
                                            <div class="bv-id-meta-row">
                                                <svg class="bv-id-meta-icon" viewBox="0 0 16 16" fill="none"
                                                    stroke="currentColor" stroke-width="1.7">
                                                    <path
                                                        d="M2 4a2 2 0 012-2h1l1.5 3-1 1a7 7 0 003 3l1-1L13 10.5V12a2 2 0 01-2 2C5 14 1 10 1 5a2 2 0 011-1.7V4z" />
                                                </svg>
                                                <div class="bv-id-meta-text">
                                                    <strong>Phone</strong>{{ $supplierProfile->phone }}</div>
                                            </div>
                                        @endif
                                        @if ($supplierProfile->city || $supplierProfile->province)
                                            <div class="bv-id-meta-row">
                                                ...
                                                <div class="bv-id-meta-text">
                                                    <strong>Location</strong>{{ implode(', ', array_filter([$supplierProfile->city, $supplierProfile->province])) }}
                                                </div>
                                            </div>
                                        @endif
                                        @if ($startingPrice)
                                            <div class="bv-id-meta-row">
                                                <svg class="bv-id-meta-icon" viewBox="0 0 16 16" fill="none"
                                                    ...
                                                    <path d="M8 5v6M6 7h3a1 1 0 010 2H7a1 1 0 000 2h3" />
                                                </svg>
                                                <div class="bv-id-meta-text"><strong>Starting
                                                        Price</strong>₱{{ number_format($startingPrice) }}</div>
                                            </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="bv-id-links">
                                        <a href="{{ route('supplier.edit', $supplierProfile->id) }}"
                                            class="bv-id-link">
                                        ...
                                        <a href="{{ route('supplier.portfolio.index', $supplierProfile->id) }}"
                                            class="bv-id-link">
                                            <svg viewBox="0 0 14 14" fill="none" stroke="currentColor"
                                                stroke-width="1.8">
                                ...
                                <div class="bv-id-right">
                                    <div>
                                        ...
                                        <div class="bv-completion-bar">
                                            <div class="bv-completion-fill" style="width:{{ $pct }}%;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="bv-sc">
                            <div class="bv-sc-head">
                                ...
                                <a href="{{ route('supplier.editidentity', $supplierProfile->id) }}"
                                    class="bv-btn-edit">
                                    <svg viewBox="0 0 14 14" fill="none" stroke="currentColor"
                                        stroke-width="1.8">
                                        <path d="M10 2l2 2-7 7H3v-2L10 2z" />
                            ...
                            <div class="bv-sc-body">
                                <div class="bv-row-grid">
                                    <div>
                                        ...
                                        <div class="bv-info-v {{ !$supplierProfile->first_name ? 'nil' : '' }}">
                                            {{ $supplierProfile->first_name ?: '—' }}</div>
                                    </div>
                                    <div>
                                        <div class="bv-info-k">Last Name</div>
                                        <div class="bv-info-v {{ !$supplierProfile->last_name ? 'nil' : '' }}">
                                            {{ $supplierProfile->last_name ?: '—' }}</div>
                                    </div>
                                    <div>
                                        <div class="bv-info-k">Business Name</div>
                                        <div class="bv-info-v {{ !$supplierProfile->business_name ? 'nil' : '' }}">
                                            {{ $supplierProfile->business_name ?: 'Using full name' }}</div>
                                    </div>
                                    <div>
                                    ...
                                    <div class="bv-row-full">
                                        ...
                                        <div class="bv-info-v {{ !$supplierProfile->tagline ? 'nil' : '' }}">
                                            {{ $supplierProfile->tagline ?: '—' }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="bv-sc-head-l">
                                    <div class="bv-sc-icon">
                                        <svg viewBox="0 0 20 20" fill="none" stroke="currentColor"
                                            stroke-width="1.7">
                                            <path
                                                d="M3 5a2 2 0 012-2h1l2 4-1.5 1.5a11 11 0 004 4L12 11l4 2v1a2 2 0 01-2 2C7.5 16 4 12.5 4 7a2 2 0 011-1.7V5z" />
                                        </svg>
                                    </div>
                                    <div>
                            ...
                            <div class="bv-sc-body">
                                <div class="bv-row-grid">
                                    <div>
                                        ...
                                        <div class="bv-info-v"><a
                                                href="mailto:{{ Auth::user()->email }}">{{ Auth::user()->email }}</a>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="bv-info-k">Phone</div>
                                        <div class="bv-info-v {{ !$supplierProfile->phone ? 'nil' : '' }}">
                                            {{ $supplierProfile->phone ?: '—' }}</div>
                                    </div>
                                    <div>
                                        <div class="bv-info-k">City</div>
                                        <div class="bv-info-v {{ !$supplierProfile->city ? 'nil' : '' }}">
                                            {{ $supplierProfile->city ?: '—' }}</div>
                                    </div>
                                    <div>
                                        <div class="bv-info-k">Province</div>
                                        <div class="bv-info-v {{ !$supplierProfile->province ? 'nil' : '' }}">
                                            {{ $supplierProfile->province ?: '—' }}</div>
                                    </div>
                                    <div class="bv-row-full">
                                        <div class="bv-info-k">Full Address</div>
                                        <div class="bv-info-v {{ !$supplierProfile->address ? 'nil' : '' }}">
                                            {{ $supplierProfile->address ?: '—' }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bv-sc">
                            ...
                            <div class="bv-sc-body" style="display:flex;flex-direction:column;gap:1rem;">
                                <div>
                                    ...
                                    <div class="bv-prose {{ !$supplierProfile->bio ? 'nil' : '' }}">
                                        {{ $supplierProfile->bio ?: 'No bio added yet. Add a bio to help clients understand who you are.' }}
                                    </div>
                                </div>
                                <div>
                                    <div class="bv-info-k" style="margin-bottom:0.4rem;">Service Description</div>
                                    <div class="bv-prose {{ !$supplierProfile->description ? 'nil' : '' }}">
                                        {{ $supplierProfile->description ?: 'No service description yet. Describe your services to attract more bookings.' }}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="panel-pricing" class="bv-tab-panel">
                        ...
                        <div class="bv-sc">
                            <div class="bv-sc-head">
                                ...
                                <a href="{{ route('supplier.editPricing', $supplierProfile->id) }}"
                                    class="bv-btn-edit">
                                    <svg viewBox="0 0 14 14" fill="none" stroke="currentColor"
                                        stroke-width="1.8">
                                        <path d="M10 2l2 2-7 7H3v-2L10 2z" />
                            ...
                            <div class="bv-sc-body">
                                ...
                                @else
                                    <div class="pr-nil">
                                        ...
                                        <span>No starting price set yet. Click <strong>Edit</strong> to add your
                                            pricing.</span>
                                    </div>
                                @endif
                            </div>
                        ...
                        {{-- Tip card --}}
                        <div class="bv-sc"
                            style="border-color:rgba(201,168,76,0.25);background:rgba(201,168,76,0.03);">
                            <div class="bv-sc-body"
                                style="display:flex;gap:1rem;align-items:flex-start;padding:1.1rem 1.4rem;">
                                <div
                                    style="width:34px;height:34px;border-radius:8px;background:rgba(201,168,76,0.12);display:flex;align-items:center;justify-content:center;color:var(--gold-dark);flex-shrink:0;">
                                ...
                                <div>
                                    <div
                                        style="font-size:0.8rem;font-weight:700;color:var(--charcoal);margin-bottom:0.25rem;font-family:var(--font-display);">
                                        Pricing Tip</div>
                                    <div style="font-size:0.76rem;color:var(--warm-grey);line-height:1.65;">
                                        Setting a starting price helps clients understand your value before reaching
                                        out. It sets clear expectations and attracts more qualified inquiries.
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        @else
            <div class="bv-sc">
                <div class="bv-sc-body bv-empty">
                    ...
                    <div class="bv-empty-desc">You haven't set up your supplier profile. Create one to start receiving
                        bookings from clients.</div>
    ...
    <div class="cp-modal-overlay" id="cpModalOverlay" onclick="if(event.target===this)cpModalClose()">
        <div class="cp-modal">
            ...
            <form id="cpUploadForm" action="{{ route('supplier.cover.store') }}" method="POST"
                enctype="multipart/form-data">
                @csrf
                <div class="cp-modal-body">
                    <div class="cp-dropzone" id="cpDropzone">
                        <input type="file" id="cpFileInput" name="cover_photo"
                            accept="image/jpeg,image/png,image/webp,image/gif" onchange="cpHandleFile(this)">
                        ...
                        <div class="cp-dropzone-sub">JPG, PNG, WEBP or GIF · Max 5 MB<br>Recommended: 1200 × 300 px
                        </div>
                    </div>
            ...
            <form id="cpRemoveForm" action="{{ route('supplier.cover.delete') }}" method="POST"
                style="display:none;">
                @csrf @method('DELETE')
            </form>
        </div>
    ...
    <script>
        ...
        function switchTab(panelId, btn) {
            document.querySelectorAll('.bv-tab').forEach(function(t) {
                t.classList.remove('active');
            });
            document.querySelectorAll('.bv-tab-panel').forEach(function(p) {
