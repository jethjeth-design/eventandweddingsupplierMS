<x-supplier-layout>
    ...
    <style>
        ...
        *::after {
        ...
        .bv-toggle-track input:checked+.bv-toggle-knob {
            background: var(--gold);
        }

        .bv-toggle-track input:checked+.bv-toggle-knob::after {
        ...
        .bv-input-wrap:focus-within .bv-input-icon {
            color: var(--gold-dark);
        }
        ...
        .incl-title-inp:focus {
            border-color: var(--gold);
            background: var(--white);
            box-shadow: 0 0 0 3px rgba(201, 168, 76, 0.12);
        }

        .incl-title-inp::placeholder {
            color: #C0B8B0;
        }
        ...
        .bv-btn-confirm-delete svg {
            width: 13px;
            height: 13px;
        }

        .bv-btn-confirm-delete:hover {
            background: #991B1B;
            transform: translateY(-1px);
        }
        ...
        <div class="bv-card reveal">
                        ...
                        <tbody>
                            @foreach ($packages as $i => $package)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($package->price)
                                            <span class="bv-price-badge"><span
                                                    class="peso">₱</span>{{ number_format($package->price, 2) }}</span>
                                        @else
                                            <span style="color:#C0B8B0;font-size:0.75rem;">—</span>
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        <div class="bv-actions">
                                            {{-- EDIT --}}
                                            <button type="button" class="bv-btn-edit" data-id="{{ $package->id }}"
                                            ...
                                            <button type="button" class="bv-btn-delete" data-id="{{ $package->id }}"
                                                data-name="{{ $package->name }}"
            ...
            @else
                <div class="bv-empty">
                    ...
                    <p class="bv-empty-sub">Click <strong>Add Package</strong> to create your first service package.
                    </p>
                </div>
            @endif
        </div>
        ...
        <div class="bv-modal">
            ...
            <form method="POST" id="package-form" action="{{ route('supplier.package.store') }}"
                ...
                <div class="bv-modal-body">
                    ...
                    <div class="bv-field">
                        <label class="bv-label" for="pkg_name">Package Name <span
                                class="bv-label-req">Required</span></label>
                        <div class="bv-input-wrap">
                            <svg class="bv-input-icon" viewBox="0 0 20 20" fill="none" stroke="currentColor"
                                stroke-width="1.7">
                    ...
                    <div class="bv-field">
                        <label class="bv-label" for="pkg_event_type">Event Type <span
                                class="bv-label-req">Required</span></label>
                        <div class="bv-input-wrap">
                            <svg class="bv-input-icon" viewBox="0 0 20 20" fill="none" stroke="currentColor"
                                stroke-width="1.7">
                    ...
                    <div class="bv-field-row">
                        <div class="bv-field" style="margin-bottom:0;">
                            <label class="bv-label" for="pkg_price">Price (₱) <span
                                    class="bv-label-opt">Optional</span></label>
                            <div class="bv-input-wrap">
                                <svg class="bv-input-icon" viewBox="0 0 20 20" fill="none" stroke="currentColor"
                                    stroke-width="1.7">
                        ...
                        <div class="bv-field" style="margin-bottom:0;">
                            <label class="bv-label" for="pkg_capacity">Min Price (₱) <span
                                    class="bv-label-opt">Optional</span></label>
                            <div class="bv-input-wrap">
                                <svg class="bv-input-icon" viewBox="0 0 20 20" fill="none" stroke="currentColor"
                                    stroke-width="1.7">
                                ...
                                <input id="pkg_capacity" name="min_price" type="number" min="1"
                    ...
                    <div class="bv-field">
                        <label class="bv-negotiable-toggle" for="pkg_is_negotiable">
                            ...
                            <div class="bv-toggle-label">
                                ...
                                <span class="bv-toggle-label-sub">Clients can submit offers within your min–max price
                                    range (Pool System)</span>
                            </div>
                        </label>
                    </div>
                    ...
                    <div class="bv-field">
                        <label class="bv-label" for="pkg_desc">Package Description <span
                                class="bv-label-opt">Optional</span></label>
                        <textarea id="pkg_desc" name="description" class="bv-textarea"
                            placeholder="Describe what's included — catering, decor, hours, add-ons…" maxlength="1000"
                            oninput="updateCount(this)"></textarea>
                        <div style="display:flex;justify-content:flex-end;margin-top:4px;">
                            <span id="desc-count"
                                style="font-size:0.62rem;color:#C0B8B0;font-family:var(--font-body);">0 / 1000</span>
                        </div>
                        @error('description')
                            <div class="bv-error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="bv-modal-section" style="margin-top:1.25rem;">
                        ...
                        Inclusions
                        <span style="font-size:0.58rem;color:#C0B8B0;margin-left:0.25rem;">— What's included in this
                            package</span>
                    </div>

                    <div
                        style="display:grid;grid-template-columns:1fr 30px;gap:0.5rem;padding:0 0 0.35rem;margin-bottom:0.1rem;">
                        <span
                            style="font-size:0.6rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#C0B8B0;font-family:var(--font-body);">Item
                            / Title</span>
                        <span></span>
                    </div>
        ...
        <div class="bv-delete-modal">
            ...
            <div class="bv-modal-header" style="border-top-color:#B91C1C;">
                <span class="bv-modal-title" style="color:#B91C1C;">
                    <svg width="16" height="16" viewBox="0 0 20 20" fill="none" stroke="currentColor"
                        stroke-width="1.8" style="display:inline;vertical-align:-3px;margin-right:6px;">
                        <circle cx="10" cy="10" r="8" />
            ...
            <div class="bv-modal-body" style="text-align:center;padding:1.75rem 1.5rem;">
                ...
                <p style="font-size:0.78rem;color:#C0B8B0;line-height:1.55;font-family:var(--font-body);">
                    This action <strong style="color:#B91C1C;">cannot be undone</strong>. All inclusions and associated
    ...
    <script>
        /* ══════════════════════════════════════════
           INCLUSION HELPERS
        ══════════════════════════════════════════ */
        function makeInclRow(listId, titleVal) {
            titleVal = titleVal || '';
        ...
        function syncRemoveBtns(listId) {
            ...
            rows.forEach(function(r) {
                r.querySelector('.incl-remove').disabled = (rows.length === 1);
            });
        }
        ...
        function populateInclList(listId, items) {
            ...
            if (!items || items.length === 0) {
                ...
                items.forEach(function(item) {
                    ...
                    list.appendChild(makeInclRow(listId, t));
                });
            }
            syncRemoveBtns(listId);
        }
        ...
        function openViewModal(btn) {
            ...
            list.innerHTML = '';
            var items = inclusions.filter(function(i) {
                return i && (i.title || i);
            });
        ...
        @if (
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                @if (old('inclusions'))
                    ...
                    populateInclList('incl-list', oldIncl);
                @endif
            });
        @endif
