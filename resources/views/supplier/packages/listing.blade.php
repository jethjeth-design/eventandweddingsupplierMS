<x-supplier-layout>
    ...
    <style>
        ...
        .sp-status.published::before {
            background: #10B981;
        }

        .sp-status.unpublished {
            background: rgba(239, 68, 68, .1);
            color: #991B1B;
            border: 1px solid rgba(239, 68, 68, .22);
        }

        .sp-status.unpublished::before {
            background: #EF4444;
        }
        ...
        .sp-toggle-btn.publish {
            background: var(--charcoal);
            color: var(--white);
        }

        .sp-toggle-btn.publish:hover {
            background: var(--gold-dark);
            box-shadow: 0 4px 12px rgba(201, 168, 76, .2);
            transform: translateY(-1px);
        }

        .sp-toggle-btn.unpublish {
            background: transparent;
            color: #C0392B;
            border: 1.5px solid #FADBD8;
        }

        .sp-toggle-btn.unpublish:hover {
            background: #FFF5F5;
            border-color: #C0392B;
        }
        ...
        <div class="sp-grid">
            ...
            @forelse($packages as $package)
                ...
                <div class="sp-card">
                    ...
                    <div class="sp-card-foot">
                        ...
                        <form method="POST" action="{{ route('supplier.package.toggle', $package->id) }}"
                            style="margin:0;">
                            @csrf
                            @if ($package->is_listed)
            ...
            @empty
                ...
                <div class="sp-empty">
                    ...
                    <div class="sp-empty-desc">You haven't added any packages.<br>Create your first package to get
                        started.</div>
                </div>
