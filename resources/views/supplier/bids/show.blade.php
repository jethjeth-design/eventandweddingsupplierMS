{{-- resources/views/bids/supplier-bid-negotiation.blade.php --}}
<x-supplier-layout>
    ...
    <style>
        ...
        .br-divider-label::before,
        .br-divider-label::after {
            content: '';
            flex: 1;
            height: 1px;
            background: var(--border);
    ...
    <div class="bidroom">
        ...
        {{-- ══ TOP BAR ══ --}}
        <div class="br-topbar">
            <a href="{{ url()->previous() ?: route('supplier.dashboard') }}" class="br-back-btn">
            ...
            <div class="br-topbar-icon">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                    <path d="M12 1v22M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6" />
                </svg>
            </div>

            <div class="br-topbar-info">
                <div class="br-topbar-name">Bid <em>Details</em></div>
                <div class="br-topbar-sub">
                    @if(isset($bid->request) && $bid->request)
                        {{ $bid->request->title ?? 'Service Request' }} · #{{ $bid->id }}
                    @else
                        Offer thread · #{{ $bid->id }}
                    @endif
                </div>
            ...
            <span class="br-status-badge {{ $statusKey }}">
                <span class="dot"></span>
                {{ ucfirst($bid->status) }}
            </span>
        </div>
        ...
        <div class="br-panel">
            ...
            <div class="br-thread" id="brThread">
                ...
                @empty
                    <div class="br-empty">
                        ...
                        <div class="br-empty-sub">Submit a counter offer below to start the negotiation.</div>
                    </div>
                @endforelse
            ...
            <div class="br-foot">
                ...
                @if($isClosed)
                    ...
                    <div class="br-closed-banner {{ $statusKey === 'accepted' ? 'accepted' : 'rejected' }}">
                ...
                @else
                    ...
                    <div class="br-quick-actions">
                        <form method="POST" action="{{ route('supplier.bids.accept', $bid) }}">
                            @csrf
                        ...
                        <form method="POST" action="{{ route('supplier.bids.reject', $bid) }}">
                            @csrf
                            <button type="submit" class="br-btn br-btn-danger">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                                    <line x1="18" y1="6" x2="6" y2="18" />
                                    <line x1="6" y1="6" x2="18" y2="18" />
                                </svg>
                    ...
                    <div class="br-divider-label">Or send a counter offer</div>

                    <form method="POST" action="{{ route('supplier.bids.counter', $bid) }}" class="br-counter-form">
                        @csrf
