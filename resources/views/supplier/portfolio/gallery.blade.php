    ...
    <div class="pf-card" style="margin-bottom:0;">
        ...
        @foreach($portfolios as $portfolio)
            @php
                ...
                // ✅ Correct class names matching your CSS
                if ($imgCount === 1)      { $cls = 'c1';     $shown = 1; }
                elseif ($imgCount === 2)  { $cls = 'c2';     $shown = 2; }
                elseif ($imgCount === 3)  { $cls = 'c3';     $shown = 3; }
                elseif ($imgCount === 4)  { $cls = 'c4';     $shown = 4; }
                elseif ($imgCount === 5)  { $cls = 'c5';     $shown = 5; }
                else                      { $cls = 'c6plus'; $shown = 4; }
            @endphp
            ...
            <div class="pf-post">
                ...
                <div class="pf-post-head">
                    <div class="pf-post-head-l">
                        ...
                        <div>
                            {{-- ✅ Show supplier name, not portfolio title --}}
                            <div class="pf-post-title">{{ Auth::user()->name }}</div>
                    ...
                    @for($ci = 0; $ci < $shown; $ci++)
                        <div class="pm">
                            ...
                            @if($ci === $shown - 1 && $imgCount > $shown)
                                <div class="pm-more">+{{ $imgCount - $shown }}</div>
                            @endif
                        </div>
                    @endfor
                </div>
