<x-client-layout>
    ...
    <style>
        ...
        .cd-stat:hover {
            box-shadow: 0 4px 18px rgba(30, 27, 24, .08);
        ...
        .cd-stat.total::before {
            background: linear-gradient(90deg, var(--gold-dark), var(--gold));
        }

        .cd-stat.pending::before {
            background: linear-gradient(90deg, #D97706, #FBBF24);
        }

        .cd-stat.confirmed::before {
            background: linear-gradient(90deg, #15803D, #4ADE80);
        }

        .cd-stat.completed::before {
            background: linear-gradient(90deg, #6B6560, #B0A89E);
        }
        ...
        .cd-stat.total .cd-stat-icon {
            background: var(--gold-light);
            color: var(--gold-dark);
        }

        .cd-stat.pending .cd-stat-icon {
            background: rgba(251, 191, 36, .12);
            color: #D97706;
        }

        .cd-stat.confirmed .cd-stat-icon {
            background: rgba(74, 222, 128, .12);
            color: #15803D;
        }

        .cd-stat.completed .cd-stat-icon {
        ...
        .cd-stat.total .cd-stat-num {
            color: var(--gold-dark);
        }

        .cd-stat.pending .cd-stat-num {
            color: #D97706;
        }

        .cd-stat.confirmed .cd-stat-num {
            color: #15803D;
        }

        .cd-stat.completed .cd-stat-num {
            color: #6B6560;
        }
        ...
        .cd-card {
            ...
            border-radius: 12px;
            overflow: hidden;
            box-shadow: 0 1px 10px rgba(30, 27, 24, .05);
        }
        ...
        .cd-card-head-title svg {
            width: 12px;
            height: 12px;
            flex-shrink: 0;
        }

        .cd-card-head-title::after {
            content: '';
            flex: 1;
            height: 1px;
        ...
        .cd-badge.confirmed .cd-badge-dot {
            background: #22C55E;
        }
        ...
        .cd-badge.cancelled .cd-badge-dot {
            background: #DC2626;
        }
        ...
        .cd-badge.completed .cd-badge-dot {
            background: #9CA3AF;
        }
            ...
            <div class="cd-card">
                ...
                <div class="cd-card-head">
                    <div class="cd-card-head-title">
                        <svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="1.8">
                            <path
                                d="M6 9l1.5 1.5L11 6M5 2H3.5A1.5 1.5 0 002 3.5v9A1.5 1.5 0 003.5 14h7A1.5 1.5 0 0012 12.5V3.5A1.5 1.5 0 0010.5 2H9" />
