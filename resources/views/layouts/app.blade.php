    ...
    <head>
        ...
        <style>
            *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            .sidebar-logout span { transition: opacity 0.2s; }
            .sidebar.collapsed .sidebar-logout span { opacity: 0; width: 0; overflow: hidden; }
            .sidebar-logout:hover { background: rgba(255,80,60,0.1); color: rgba(255,120,100,1); }
            .sidebar.collapsed .sidebar-logout { justify-content: center; padding: 0.65rem; }
            ...
            .nav-submenu {
                display: none;
                flex-direction: column;
                margin: 0 0.6rem 0.25rem 2.8rem;
            ...
            .nav-subitem svg { width: 14px; height: 14px; flex-shrink: 0; color: rgba(255,255,255,0.25); transition: color 0.15s; }
            .nav-subitem:hover { background: rgba(201,168,76,0.08); color: rgba(255,255,255,0.85); }
            .nav-subitem:hover svg { color: var(--gold-light); }
            .nav-subitem.active { color: var(--gold-light); font-weight: 500; }
            .nav-subitem.active svg { color: var(--gold-light); }
